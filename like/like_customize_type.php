<?php
	...
	$vkontakte_like='';
	$mailru_like='';
	if(get_option($this->pluginPrefix . 'vkontakte_like_button_show')==1) {
...
/*		$vkontakte_like .= '}';
	...
	if(get_option($this->pluginPrefix . 'mailru_like_button_show')==1) {

		$width_mailru = get_option($this->pluginPrefix . 'mailru_like_width');
		$show_text_mailru = get_option($this->pluginPrefix . 'mailru_like_show_text');

		$faces_mailru = get_option($this->pluginPrefix . 'mailru_like_faces');
		$verb_mailru = get_option($this->pluginPrefix . 'mailru_like_verb');
//		$verb_mailru = _e('Like');
	...
	if(get_option($this->pluginPrefix . 'facebook_like_button_show')==1) {
		$layout_fb = get_option($this->pluginPrefix . 'facebook_like_layout');
		$verb_fb   = get_option($this->pluginPrefix . 'facebook_like_verb');
		$width_fb  = get_option($this->pluginPrefix . 'facebook_like_width');
		$height_fb = get_option($this->pluginPrefix . 'facebook_like_height');
		$color_fb  = get_option($this->pluginPrefix . 'facebook_like_color');
		$faces_fb  = get_option($this->pluginPrefix . 'facebook_like_faces');
	...
	$button_code .= $facebook_like.$mailru_like.$vkontakte_like;
