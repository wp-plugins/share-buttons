...
2. Sort Buttons, Choose style
3. Enable/Disabled buttons
4. Margins top and bottom
5. Header text before social buttons
6. Position Share Buttons
7. Twitter via "@"
8. Like button - Vkontakte
9. Like button - Facebook
10. Like button - Mailru
== Changelog ==
