...
jQuery(document).ready(function($){
	...
	if($("input[name='sbuttons_vkontakte_like_button_show']").attr('checked')) {
		$("#vkontakte_like_sample_buttons").show();
	} else {
		$("#vkontakte_like_sample_buttons").hide();
	}

	if($("input[name='sbuttons_facebook_like_button_show']").attr('checked')) {
		$("#facebook_like_button").show();
	} else {
		$("#facebook_like_button").hide();
	}

	if($("input[name='sbuttons_mailru_like_button_show']").attr('checked')) {
		$("#mailru_like_button").show();
	} else {
		$("#mailru_like_button").hide();
	}

	$("input[name='sbuttons_vkontakte_like_button_show']").change(function(){
		if (this.checked) {
	...
	$("input[name='sbuttons_facebook_like_button_show']").change(function(){
		if (this.checked) {
	...
	$("input[name='sbuttons_mailru_like_button_show']").change(function(){
		if (this.checked) {
		...
		<div style="margin-right: 160px;">
				...
				<fieldset class="fieldset_style">
					...
					<div id="customize_type" class="body_style">
						<div style="width:450px;">
							<div>
								<input type="radio" name="<?php echo $this->pluginPrefix; ?>opt_customize_type" id="opt_customize_type" value="original_count" <?php echo (get_option($this->pluginPrefix . 'opt_customize_type') == 'original_count' ? 'checked' : ''); ?> />01. <?php _e('Original with count', $this->plugin_domain);?>
							</div>
							<div style="margin-top:5px;margin-left:15px;">
								<img src="<?php echo $this->plugin_url;?>images/social/original_count.jpg" />
							</div>
						</div>
						<br />
						<div style="width:450px;margin-top:15px;">
							<div>
								<input type="radio" name="<?php echo $this->pluginPrefix; ?>opt_customize_type" id="opt_customize_type" value="soft_round" <?php echo (get_option($this->pluginPrefix . 'opt_customize_type') == 'soft_round' ? 'checked' : ''); ?> />01. <?php _e('Soft Round', $this->plugin_domain);?>
							</div>
							<div style="margin-top:5px;margin-left:15px;">
								<img src="<?php echo $this->plugin_url;?>images/social/soft_round.jpg" />
							</div>
						</div>
						<br />
						<div style="width:450px;margin-top:15px;">
							<div>
								<input type="radio" name="<?php echo $this->pluginPrefix; ?>opt_customize_type" id="opt_customize_type" value="soft_rect" <?php echo (get_option($this->pluginPrefix . 'opt_customize_type') == 'soft_rect' ? 'checked' : ''); ?> />02. <?php _e('Soft Rectangle', $this->plugin_domain);?>
							</div>
							<div style="margin-top:5px;margin-left:15px;">
								<img src="<?php echo $this->plugin_url;?>images/social/soft_rect.jpg" />
							</div>
						</div>
						<br />
						<div style="width:450px; margin-top:15px;">
							<div>
								<input type="radio" name="<?php echo $this->pluginPrefix; ?>opt_customize_type" id="opt_customize_type" value="classic" <?php echo (get_option($this->pluginPrefix . 'opt_customize_type') == 'classic' ? 'checked' : ''); ?> />03. <?php _e('Classic', $this->plugin_domain);?>
							</div>
							<div style="margin-top:5px;margin-left:15px;">
								<img src="<?php echo $this->plugin_url;?>images/social/classic.jpg" />
							</div>
						</div>
						<br />
						<div style="width:450px; margin-top:15px;">
							<div>
								<input type="radio" name="<?php echo $this->pluginPrefix; ?>opt_customize_type" id="opt_customize_type" value="mini" <?php echo (get_option($this->pluginPrefix . 'opt_customize_type') == 'mini' ? 'checked' : ''); ?> />04. <?php _e('Classic mini', $this->plugin_domain);?>
							</div>
							<div style="margin-top:5px;margin-left:15px;">
								<img src="<?php echo $this->plugin_url;?>images/social/mini.jpg" />
							</div>
						</div>
					</div>
				</fieldset>
			...
			<fieldset class="fieldset_position">
				...
				<div class="body_other">
					...
					<br/>
					<div><?php _e('Margin top', $this->plugin_domain);?>:</div>
					<div><input type="text" name="<?php echo $this->pluginPrefix; ?>margin_top" size="35" value="<?php echo esc_attr($this->margin_top);?>" class="regular-text" /></div>
					<br />
					<div><?php _e('Margin bottom', $this->plugin_domain);?>:</div>
					<div><input type="text" name="<?php echo $this->pluginPrefix; ?>margin_bottom" size="35" value="<?php echo esc_attr($this->margin_bottom);?>" class="regular-text" /></div>
				</div>
				<br />
			</fieldset>
			...
			<fieldset class="fieldset_position">
				...
				<div class="body_other">
					...
					<div><input type="text" name="<?php echo $this->pluginPrefix; ?>header_text" size="100" value="<?php echo esc_attr($this->header_text);?>" class="regular-text" /></div>
				</div>
			</fieldset>
			...
			<fieldset class="fieldset_position">
				...
				<table class="form-table">
					...
					<th scope="row"><label for="share_buttons_exclude"><?php _e('Exclude pages and posts with IDs', $this->plugin_domain) ?></label></th>
						<td>
							<input type="text" name="<?php echo $this->pluginPrefix; ?>exclude" value="<?php echo esc_attr($this->exclude); ?>" class="regular-text" />
			...
			<fieldset class="fieldset_position">
				...
				<div class="body_other">
						...
						<div><input type="text" name="<?php echo $this->pluginPrefix; ?>twitter_via" value="<?php echo esc_attr($this->twitter_via);?>" class="regular-text" /></div>
<!-- in develop			<br />
...
<!-- Vkontakte.ru Like Button -->
				...
				<div class="head_social">
					<input name="<?php echo $this->pluginPrefix; ?>vkontakte_like_button_show" type="checkbox" id="vkontakte_like_show" value="1" <?php checked(TRUE, $this->vkontakte_like_show); ?> />
					<?php _e('Show Vkontakte.ru Like Button', $this->plugin_domain) ?>
				</div>

				<div class="body_social" id="vkontakte_like_sample_buttons">
					<div><img name="<?php echo $this->pluginPrefix; ?>vk_pic_like" id="vk_pic_like" src="<?php echo $this->plugin_url;?>/like/images/vkontakte/full-like.png" /></div>
					<br />
					<div>
					...
					<div>
						...
						<div>
							<select name="<?php echo $this->pluginPrefix; ?>vkontakte_like_verb" id="vkontakte_like_verb" value="<?php echo $vk_like_verb; ?>">
				...
				<div class="head_social">
					<input name="<?php echo $this->pluginPrefix; ?>facebook_like_button_show" type="checkbox" id="facebook_like_show" value="1" <?php checked(TRUE, $this->facebook_like_show); ?> />
				...
				<div class="body_social" id="facebook_like_button">
					<div><img name="<?php echo $this->pluginPrefix; ?>fb_pic_like" id="fb_pic_like" src="<?php echo $this->plugin_url;?>/like/images/facebook/standart-like-light.png" /></div>
					<br />
					...
					<div>
						<select name="<?php echo $this->pluginPrefix; ?>facebook_like_layout" id="facebook_like_layout" value="<?php echo $fb_like_layout; ?>">
					...
					<div>
						...
						<div>
							<input name="<?php echo $this->pluginPrefix; ?>facebook_like_faces" type="checkbox" id="facebook_like_faces" value="1" <?php checked(TRUE, $this->facebook_like_faces); if($this->facebook_like_faces==TRUE && $this->facebook_like_height<70) { update_option($this->pluginPrefix . 'facebook_like_height',70); } ?> />
					...
					<div>
						...
						<div><input type="text" name="<?php echo $this->pluginPrefix; ?>facebook_like_width" value="<?php echo esc_attr($this->facebook_like_width);?>" class="regular-text" /></div>
					</div>
					<br />
					<div>
						...
						<div><input type="text" name="<?php echo $this->pluginPrefix; ?>facebook_like_height" value="<?php echo esc_attr($this->facebook_like_height);?>" class="regular-text" /></div>
					</div>
					<br />
					<div>
						...
						<div>
							<select name="<?php echo $this->pluginPrefix; ?>facebook_like_verb" id="facebook_like_verb" value="<?php echo $fb_like_verb; ?>">
					...
					<div>
						...
						<div>
							<select name="<?php echo $this->pluginPrefix; ?>facebook_like_color" id="facebook_like_color" value="<?php echo $fb_like_color; ?>">
				...
				<div class="head_social">
					<input name="<?php echo $this->pluginPrefix; ?>mailru_like_button_show" type="checkbox" id="mailru_like_show" value="1" <?php checked(TRUE, $this->mailru_like_show); ?> />
				...
				<div class="body_social" id="mailru_like_button">
					<div>
						<img name="<?php echo $this->pluginPrefix; ?>mr_pic_like" id="mr_pic_like" src="<?php echo $this->plugin_url;?>/like/images/mailru/mailru_like.png" />
					</div>
					<br />
					<div>
						<div><?php _e('Show Faces');?>&nbsp;<span class="description">(<?php _e('Show profile pictures below the button');?>)</span></div>
						<div>
							<input name="<?php echo $this->pluginPrefix; ?>mailru_like_faces" type="checkbox" id="mailru_like_faces" value="1" <?php checked(TRUE, $this->mailru_like_faces); ?> />
							<?php _e('Show faces', $this->plugin_domain) ?>
						</div>
					</div>
					<br />
					<div>
						...
						<div>
							<input name="<?php echo $this->pluginPrefix; ?>mailru_like_show_text" type="checkbox" id="mailru_like_show_text" value="1" <?php checked(TRUE, $this->mailru_like_show_text); if($this->mailru_like_show_text==FALSE && $this->mailru_like_width>90) { update_option($this->pluginPrefix . 'mailru_like_width',90); } else if($this->mailru_like_show_text==TRUE && $this->mailru_like_width<550) { update_option($this->pluginPrefix . 'mailru_like_width',550); } ?> />
					...
					<div>
						<div><?php _e('Width', $this->plugin_domain); ?>&nbsp;<span class="description">(<?php _e('The width of the plugin, in pixels', $this->plugin_domain);?>)</span></div>
                        <div><input type="text" name="<?php echo $this->pluginPrefix; ?>mailru_like_width" value="<?php echo esc_attr($this->mailru_like_width);?>" class="regular-text" /></div>
					</div>
					<br />
<!--                    <div>
                        <div><?php _e('Verb to display', $this->plugin_domain) ?>&nbsp;<span class="description">(<?php _e('The verb to display in the button. Currently only Like and Recommend are supported', $this->plugin_domain) ?>)</span></div>
